...
const (
	UserService_GetAllUsers_FullMethodName = "/api.UserService/GetAllUsers"
	UserService_PostUser_FullMethodName    = "/api.UserService/PostUser"
...
type UserServiceClient interface {
	GetAllUsers(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*UserListResponse, error)
	PostUser(ctx context.Context, in *UserPostRequest, opts ...grpc.CallOption) (*UserPostResponse, error)
...
func (c *userServiceClient) GetAllUsers(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*UserListResponse, error) {
...
func (c *userServiceClient) PostUser(ctx context.Context, in *UserPostRequest, opts ...grpc.CallOption) (*UserPostResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *userServiceClient) DeleteUser(ctx context.Context, in *UserDeleteRequest, opts ...grpc.CallOption) (*UserDeleteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	GetAllUsers(context.Context, *empty.Empty) (*UserListResponse, error)
	PostUser(context.Context, *UserPostRequest) (*UserPostResponse, error)
...
func (UnimplementedUserServiceServer) GetAllUsers(context.Context, *empty.Empty) (*UserListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllUsers not implemented")
}
func (UnimplementedUserServiceServer) PostUser(context.Context, *UserPostRequest) (*UserPostResponse, error) {
...
func (UnimplementedUserServiceServer) DeleteUser(context.Context, *UserDeleteRequest) (*UserDeleteResponse, error) {
...
func _UserService_PostUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).PostUser(ctx, req.(*UserPostRequest))
	}
	return interceptor(ctx, in, info, handler)
}
